 ...
 */
     ...
     */ 
        ...
        public static function selectOneColumn($query, $bindings = [], $useReadPdo = true)
        {
                        ...
                        return $instance->selectOneColumn($query, $bindings, $useReadPdo);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function selectColumns($query, $bindings = [], $useReadPdo = true)
        {
                        /** @var \MobileStock\Shared\PdoInterceptor\Laravel\MysqlConnection $instance */
                        return $instance->selectColumns($query, $bindings, $useReadPdo);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getLock(...$identificadores)
        {
                        /** @var \MobileStock\Shared\PdoInterceptor\Laravel\MysqlConnection $instance */
                        return $instance->getLock(...$identificadores);
        }
                    /**
     ...
     */ 
         ...
         * @static 
         */ 
        public static function iugu()
        {
                        return \Illuminate\Http\Client\Factory::iugu();
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Http\Client\Factory::mobilestock();
        }
     ...
     */ 
        ...
        {            //Method inherited from \Illuminate\Queue\Queue         
                        /** @var \Illuminate\Queue\NullQueue $instance */
        ...
        {            //Method inherited from \Illuminate\Queue\Queue         
                        \Illuminate\Queue\NullQueue::createPayloadUsing($callback);
        }
                    /**
...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function defaultTimestamps($precision = 0)
        {
                        return Blueprint::defaultTimestamps($precision);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function uuidPrimary()
        {
                        return Blueprint::uuidPrimary();
        }
