    ...
    <div class="row">
      ...
      <div class="col-sm-2"><label>Fornecedor:</label><select name="id_fornecedor"
        ...
        <div class="row">
          ...
          <div class="col-sm-4"><button class="btn btn-success btn-block" type="submit"><b>FILTRAR</b></button></div>
        </div>
  </div>
</form>
<br/>
<div class="row cabecalho">
      ...
      <?php if ($produtos != null) {
        ...
        <div class="row corpo <?= $estilo ?>">
          ...
          <div class="col-sm-2"><?php if (isset($produto['usuario'])) {
              echo $produto['usuario'];
          } ?></div>
          <div class="col-sm-2"><?php if (isset($produto['data_emissao'])) {
              echo $produto['data_emissao'];
          } ?></div>
          <div class="col-sm-1">
            <a href="produto-corrigir-estoque-detalhes.php?id=<?= $produto[
                'id'
