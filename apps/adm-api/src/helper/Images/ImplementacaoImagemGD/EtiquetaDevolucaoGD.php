        ...
        switch ($this->tipoProblema) {
            case 'PRAZO_EXPIRADO_7':
                ...
                parent::aplicarTexto(
                    ...
                    73,
                    90,
                    'O produto não foi bipado pelo ponto dentro do prazo de 7 dias.'
                );
            ...
            case 'PRAZO_EXPIRADO_60':
                ...
                parent::aplicarTexto(
                    ...
                    40,
                    80,
                    'Esse produto é de uma compra do meulook que já passou do prazo'
                );
            ...
            case 'SOLICITACAO_PENDENTE':
                ...
                parent::aplicarTexto(
                    ...
                    75,
                    100,
                    'O produto ainda está aguardando a aprovação do fornecedor.'
                );
                break;
        }
