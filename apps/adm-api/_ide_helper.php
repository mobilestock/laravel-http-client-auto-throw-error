...
if (!function_exists('app')) {
    /**
     * Função duplicada do laravel com o objetivo de evitar de baixar toda a lib do laravel
     * Get the available container instance.
     *
     * @template T of mixed
     * @param class-string<T|mixed> $make
     * @param array $parameters
     * @return T|\Illuminate\Contracts\Container\Container
     */
...
namespace Illuminate\Support\Facades {
    ...
    class Auth
    {
        ...
        {
            /** @var \MobileStock\helper\Auth\TokenAdmGuard $instance */
        ...
        {
            //Method inherited from \Illuminate\Auth\TokenGuard
            /** @var \MobileStock\helper\Auth\TokenAdmGuard $instance */
         ...
         * @return \MobileStock\helper\Auth\TokenAdmGuard
         * @static
         */
    ...
    class DB
    {
        ...
        public static function isMaria()
        {
            ...
            /** @var \MobileStock\Shared\PdoInterceptor\Laravel\MysqlConnection $instance */
         ...
         *
         * @param \Closure $callback
         * @return \MobileStock\Shared\PdoInterceptor\Laravel\MysqlConnection
         * @static
         */
        ...
        {
            //Method inherited from \Illuminate\Database\Connection
            \MobileStock\Shared\PdoInterceptor\Laravel\MysqlConnection::resolverFor($driver, $callback);
        }
        /**
        ...
        {
            //Method inherited from \Illuminate\Database\Connection
            return \MobileStock\Shared\PdoInterceptor\Laravel\MysqlConnection::getResolver($driver);
        }
        /**
        ...
        public static function selectColumns($query, $bindings = [], $useReadPdo = true): array
        {
            /** @var \MobileStock\Shared\PdoInterceptor\Laravel\MysqlConnection $instance */
            $instance->selectColumns($query, $bindings, $useReadPdo);
        }

        /**
         * @return mixed
         */
        public static function selectOneColumn($query, $bindings = [], $useReadPdo = true)
        {
            /** @var \MobileStock\Shared\PdoInterceptor\Laravel\MysqlConnection $instance */
            $instance->selectOneColumn($query, $bindings, $useReadPdo);
        }

        /**
         * @return void
         */
        public static function getLock(...$args)
        {
            /** @var \MobileStock\Shared\PdoInterceptor\Laravel\MysqlConnection $instance */
            $instance->getLock(...$args);
        }
    }
    /**
     *
    ...
    class Event
    {
         ...
         * @static
         */
        public static function listenOnce($events, $listener = null)
        {
            return \Illuminate\Events\Dispatcher::listenOnce($events, $listener);
        }
        /**
    ...
    class Queue
    {
         ...
         * @static
         */
        public static function setSqs($sqs)
        {
            /** @var \ShiftOneLabs\LaravelSqsFifoQueue\SqsFifoQueue $instance */
            return $instance->setSqs($sqs);
        }
        /**
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue
            \ShiftOneLabs\LaravelSqsFifoQueue\SqsFifoQueue::createPayloadUsing($callback);
        }
        /**
    ...
    class Request
    {
         ...
         * @static
         */
        public static function telefone($key = 'telefone')
        {
            return \Illuminate\Http\Request::telefone($key);
        }
    }
    /**
     *
...
namespace Illuminate\Support {
    ...
    class Str
    {
         ...
         * @static
         */
        public static function toUtf8($texto)
        {
            return Str::toUtf8($texto);
        }
        /**
         *
         ...
         * @static
         */
        public static function retornaSigla($texto)
        {
            return Str::retornaSigla($texto);
        }
        /**
         *
         * @description Formata um telefone e retorna no formato (XX) XXXXX-XXXX
         * @see \MobileStock\helper\Providers\MacroServiceProvider::boot()
...
namespace Illuminate\Events {
    ...
    class Dispatcher
    {
        ...
        public static function listenOnce($events, $listener = null)
        {
            return Dispatcher::listenOnce($events, $listener);
        }
    }
}
...
namespace Illuminate\Support {
    ...
    {
        /**
         * @description Acrescenta dias úteis a data
         * @param int $qtdMinimaDia
         * @return self
         */
        public function acrescentaDiasUteis(int $qtdMinimaDia)
        {
            // Vazio
        }
    }
