...
new Vue({
  ...
  data() {
    return {
      ...
      pontuacoes: {
        pontuacao_atraso_separacao: 0,
        pontuacao_avaliacao_4_estrelas: 0,
        pontuacao_avaliacao_5_estrelas: 0,
        pontuacao_cancelamento: 0,
        pontuacao_devolucao_defeito: 0,
        pontuacao_devolucao_normal: 0,
        pontuacao_fulfillment: 0,
        pontuacao_reputacao_excelente: 0,
        pontuacao_reputacao_melhor_fabricante: 0,
        pontuacao_reputacao_regular: 0,
        pontuacao_reputacao_ruim: 0,
        pontuacao_venda: 0,
      },
      ultimaPagina: false,
