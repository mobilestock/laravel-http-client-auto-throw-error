...
return new class extends AbstractJob {
    ...
    public function run(): void
    {
        ...
        foreach ($produtosParaAtualizar as $index => $produto) {
            ...
            $produtoModel->valor_venda_ms = $produto['valor_venda_ms'] + self::TAXA_PRODUTO_BARATO;
            $produtoModel->valor_venda_ml = $produto['valor_venda_ml'] + self::TAXA_PRODUTO_BARATO;
            $produtoModel->update();
