...
- Cores adicionais que tiverem alguma HEX especial, com transparencia, devem informar seu alfa no nome também, usando `A` para referência. Abaixo, tem um exemplo usando red38 como referencia.
Exemplo:
...
export default {
  ...
  orangeRed50: '#F56200',
  red38: '#B50D48',
  red38A20: '#B50D4833', // rgba(181, 13, 72, 0.2)
  red50: '#FF0000',
  white50: '#EEEBEB',
  yellow20: '#FFC700'
