...
class CastWithDatabaseColumnsTest extends TestCase
{
    public function suiteTestes(): Generator
    {
        ...
        // yield 'Fetch assoc bool com verbo prefixo' => [
        //     [
        //         [
        //             'esta_pago' => '1',
        //         ],
        ...
        // yield 'Fech assoc com bool verbo, int e float' => [
        //     [
        //         [
        //             'esta_pago' => '1',
        //             'valor' => '1',
        ...
        // yield 'Fetch JSON recursive with alias' => [
        //     [
        //         [
        ...
        // yield 'Fetch JSON recursivo + 10 profundidade' => [
        //     [
        //         [
        //             'campo_json' =>
        //                 '{"item1":{"item2":{"item3":{"item4":{"item5":{"item6":{"item7":{"item8":{"item9":{"item10":{"eh_cast":0}}}}}}}}}}}',
        //         ],
        //     ],
        //     function () {
        ...
        // yield 'Fetch JSON dois campos iguais' => [
        //     [
        //         [
    ...
    {
        $stmt = new PdoCastStatement(
            (new Pipeline())->through(function (array $data, callable $next) {
                $middleware = new CastWithDatabaseColumns(['eh', 'deve']);
