...
class CastWithDatabaseColumnsTest extends TestCase
{
    public function consultasEsperaResultados(): Generator
    {
        ...
        $estruturaNova[0]['campo'] = json_decode(str_replace('"eh_cast":0', '"eh_cast":false', $json), true, 514);
        yield '[PDO::FETCH_ASSOC ] recursivo + 512 profundidade' => [$estrutura, $estruturaNova];
