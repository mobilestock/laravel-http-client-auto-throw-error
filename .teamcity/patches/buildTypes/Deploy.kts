    ...
    steps {
        update<ScriptBuildStep>(11) {
            ...
            scriptContent = """
                ...
                MESSAGE="O build %system.build.number% do projeto %system.teamcity.projectName% na branch %teamcity.build.branch% falhou ao tentar fazer o deploy. Detalhes: %env.BUILD_URL%"
